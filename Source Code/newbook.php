            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">New Books Arrived</h1>
                        <div class="row">
                            <div class="col-xl-60 col-md-60">
                            <?php
                                        $sqltran = mysqli_query($con, "SELECT * FROM book WHERE Times_Arrived BETWEEN (NOW() - INTERVAL 2 WEEK) AND NOW() ORDER BY Times_Arrived DESC")or die(mysqli_error($con));
